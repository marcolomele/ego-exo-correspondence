...
### Input
- **Split files**: `split.json` containing train/val/test UIDs
- **Annotation files**: `data/annotations/relation_annotations/relations_{split}.json` with mask annotations
...
[
  [
    "root//take_uid//aria01//object//rgb//0",
    "root//take_uid//aria01//object//mask//0",
    "root//take_uid//cam01//object//rgb//0",
    "root//take_uid//cam01//object//mask//0"
  ],
  ...
]
```
